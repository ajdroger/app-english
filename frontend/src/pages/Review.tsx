  ...
  if (total === 0) {
    return (
      <div className="flex flex-col items-center gap-4 mt-20 text-center">
        ...
        <p className="text-gray-500 dark:text-gray-400">You've mastered all the words so far. Come back after studying new ones.</p>
      </div>
    )
  }
  ...
  return (
    <div className="flex flex-col items-center gap-6 max-w-lg mx-auto">
      ...
      <div className="w-full flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">Review</h1>
